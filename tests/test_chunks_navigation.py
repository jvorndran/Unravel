...
class TestGoToUploadStepButton:
    ...
    def mock_streamlit(self):
        ...
        with patch("unravel.ui.steps.chunks.st") as mock_st:
    ...
    def mock_ui(self):
        ...
        with patch("unravel.ui.steps.chunks.ui") as mock_ui:
    ...
    def test_early_return_when_no_document(self, mock_streamlit, mock_ui):
        ...
        with patch("unravel.ui.steps.chunks.get_chunks") as mock_get_chunks:
            render_chunks_step()
    ...
    def test_button_not_shown_when_document_selected(self, mock_streamlit, mock_ui):
        ...
        with patch(
            "unravel.ui.steps.chunks.get_storage_dir",
            return_value=Path("/tmp/storage"),
        ):
            with patch("unravel.ui.steps.chunks.get_chunks", return_value=[]):
                render_chunks_step()
