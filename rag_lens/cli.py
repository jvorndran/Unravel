...
@click.version_option(package_name="rag-lens")
def main(port: int, host: str) -> None:
    """Launch the RAG Lens Streamlit application.
    ...
    click.echo(f"Starting RAG Lens on http://{host}:{port}")
