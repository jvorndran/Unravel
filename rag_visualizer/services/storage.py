"""Local file storage management for RAG Visualizer.

Manages the ~/.rag-visualizer/ directory for storing:
- Uploaded documents
- Processed chunks
- Cached embeddings
...
def get_storage_dir() -> Path:
    ...
    Returns:
        Path to the storage directory (~/.rag-visualizer/)
    """
...
def load_session_state() -> dict[str, Any] | None:
    ...
    from rag_visualizer.services.chunking import Chunk
    from rag_visualizer.services.vector_store import VectorStore
